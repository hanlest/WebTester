...
type AppView = "session" | "projects" | "history" | "bugs" | "settings";
    ...
    <div className="app">
      <div className="sidebar">
        ...
        <div className="form-group">
          <label>Tema visual (Fase 7)</label>
        ...
        {view === "session" && (
          <>
            <div className="form-group">
              ...
              <select value={targetAppId} onChange={(e) => setTargetAppId(e.target.value)} disabled={!!sessionId}>
